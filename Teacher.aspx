        ...
        <div>
            <asp:FormView ID="FormView1" runat="server" DataKeyNames="TEACHER_ID" DataSourceID="SqlDataSource1" Class="table">
                <EditItemTemplate>
                    ...
                    <asp:RegularExpressionValidator ID="regexStudentName" runat="server" ControlToValidate="TEACHER_NAMETextBox" ErrorMessage="*Student Name can only contain characters" ForeColor="Red" ValidationExpression="^[a-zA-Z ]*$" Font-Size="X-Small"></asp:RegularExpressionValidator>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="*Student Name cannot be blank" ControlToValidate="TEACHER_NAMETextBox" ForeColor="Red" Font-Size="X-Small"></asp:RequiredFieldValidator>
                    <br />
                    TEACHER_EMAIL:
