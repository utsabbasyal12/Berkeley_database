...
<body>
   <aside class="sidebar">
    ...
    <form id="form1" runat="server">
        <div>
            <asp:Label ID="Label1" runat="server" Text="Label"><h1>Student-Assignment Table</h1></asp:Label>
            <br />
            <br />
            ...
            <asp:DropDownList ID="DropDownList1" runat="server" AutoPostBack="True" DataSourceID="SqlDataSource1" DataTextField="STUDENT_NAME" DataValueField="STUDENT_NAME" CssClass="table">
            </asp:DropDownList>
        </div>
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="STUDENT_ID,MODULE_CODE,ASSIGNMENT_ID,GRADE" DataSourceID="SqlDataSource2" CssClass="table">
            <Columns>
